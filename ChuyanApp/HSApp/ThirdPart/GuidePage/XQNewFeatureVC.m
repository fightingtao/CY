...
- (void)viewDidLoad {
    ...
    pageControl.pageIndicatorTintColor   = ViewBgColor;
        ...
        for (int i = 0; i<self.imagesNameArray.count; i++) {
            ...
            if (i == self.imagesNameArray.count - 1) {
                if (!self.completeBtn) {
                    ...
                    completeBtn.layer.cornerRadius  = self.completeBtnCornerRadius?self.completeBtnCornerRadius:5;
                    completeBtn.layer.masksToBounds = YES;
                    completeBtn.layer.borderColor = [UIColor redColor].CGColor;
