...
- (void)viewDidLoad
{
    ...
    [g_backGroundImage setImage:[[communcation sharedInstance] createImageWithColor:[UIColor whiteColor]]];
...
-(void)setNavigationBackButton{
    if (_rootViewController) {
        ...
        if (g_menuFlags.canShowLeft) {
            ...
            [leftBtn setImage:[UIImage imageNamed:@"nav_leftbar_info"] forState:UIControlStateNormal];
...
//        [view addGestureRecognizer:pan];
        ...
        UIPanGestureRecognizer *g_pan=[[UIPanGestureRecognizer alloc]initWithTarget:self action:@selector(tapInRootController)];
        if (_rootViewController.view) {
            [_rootViewController.view addGestureRecognizer:g_tap];
            [_rootViewController.view addGestureRecognizer:g_pan];
        }
        [g_tap setEnabled:NO];
    } else {
        if (tempRoot) {
