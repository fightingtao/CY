...
-(UIImage*)defaultIcon{
    if (!_defaultIcon) {
        ...
        _defaultIcon = [self loadPlistIcon] ?:[UIImage imageNamed:@"AppIcon"] ?:[UIImage imageNamed:@"AppIcon-1"] ?:[UIImage imageNamed:@"AppIcon-2"] ?:[UIImage imageNamed:@"AppIcon-3"] ?:[UIImage imageNamed:@"Icon-60@2x"];
    }
    return _defaultIcon;
}
