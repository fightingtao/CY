...
@protocol OrderIngCellDelegate <NSObject>
///选择经纪人
...
@interface CHomeOrderIngTableViewCell : UITableViewCell
@property (nonatomic, strong) id<OrderIngCellDelegate>delegate;
...
- (void)timerFireMethod:(NSTimer *)timer AndDate:(NSString*)date;
