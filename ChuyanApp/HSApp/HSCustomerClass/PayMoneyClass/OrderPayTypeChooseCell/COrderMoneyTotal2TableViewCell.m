//
//  COrderMoneyTotal2TableViewCell.m
//  HSApp
//
...
@implementation COrderMoneyTotal2TableViewCell
...
{
    return OrderMoneyTotal2CellHeight;
}
...
- (void)setOrderContentWithModel:(Out_ReadyPayDetailBody*)model And:(Out_RedPacketBody*)redModel
{
    ...
    double needPay = model.tip-redModel.amount;
    if (needPay <= 0) {
