...
@protocol OrderDynamicDelegate <NSObject>
...
@interface DynamicOrderTableViewCell : UITableViewCell

@property (nonatomic, strong) id<OrderDynamicDelegate>delegate;
...
@property (nonatomic, strong) Out_OrderDynamicBody *model;

- (CGFloat)cellHeightWithModel:(Out_OrderDynamicBody*)model;

//- (void)setOrderContentWithModel:(Out_OrderDynamicBody*)model;
@end
