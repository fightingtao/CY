//
//  COrderDetailPayTableViewCell.m
//  HSApp
//
...
@implementation COrderDetailPayTableViewCell
...
- (void)setOrderContentWithModel:(Out_OrderDetailBody*)model
{
    if (model.statusId < 4)
    {
        ...
        double allDiscount = model.discount+model.redAmount;
        _disTotalLabel.text = [NSString stringWithFormat:@"已优惠%.2f元",allDiscount];
