...
- (void)rightItemClick
{
    ...
    NSArray *dataArray = [[NSArray alloc] initWithObjects:content, nil];
    NSString *hamcString = [[communcation sharedInstance] ArrayCompareAndHMac:dataArray];
    

    dispatch_async(dispatch_get_global_queue(0, 0), ^{
        Out_AllSameModel *outModel = [[communcation sharedInstance] userLFeedBackWith:userInfoModel.userId andDigest:hamcString andcontent:content];
